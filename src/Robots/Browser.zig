...
pub const Chrome = struct {
    ...
    pub const Version = enum(u16) {
        ...
        pub const VerDates = [_]VerDate{
            ...
            .{ 144, 1767744000 }, .{ 145, 1769558400 }, .{ 146, 1771977600 }, .{ 147, 1774396800 },
            .{ 148, 1776816000 }, .{ 149, 1779235200 }, .{ 150, 1781679600 }, .{ 151, 1784098800 },
            // 153-155 is prospective and unconfirmed
            .{ 152, 1786518000 }, .{ 153, 1789023600 }, .{ 154, 1791442800 }, .{ 155, 1794124800 },
        };
    };
...
pub const Firefox = struct {
    ...
    pub const Version = enum(u16) {
        ...
        pub const VerDates = [_]VerDate{
            ...
            .{ 144, 1760400000 }, .{ 145, 1762819200 }, .{ 146, 1765238400 }, .{ 147, 1768262400 },
            .{ 148, 1771891200 }, .{ 149, 1774310400 }, .{ 150, 1776754800 }, .{ 151, 1779174000 },
            // 153-155 is prospective and unconfirmed
            .{ 152, 1781593200 }, .{ 153, 1789023600 }, .{ 154, 1791442800 }, .{ 155, 1794124800 },
        };
    };
};
